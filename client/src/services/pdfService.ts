 ...
 */
export async function generatePDFReport(reportData: PDFReportData): Promise<Blob> {
 ...
 */
export async function downloadPDFReport(reportData: PDFReportData, filename?: string): Promise<void> {
  try {
