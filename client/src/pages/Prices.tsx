    ...
    return (
        <PageLayout>
            ...
            <div className="space-y-4 text-center">
                ...
                <p>Choose your credit plan for AI-powered PFT interpretation</p>
            </div>
            ...
            <div className="mx-auto flex w-fit rounded-full bg-[#F3F4F6] p-1 dark:bg-[#222] my-6">
                ...
                <button className="relative w-fit px-4 py-2 text-sm font-semibold capitalize text-foreground transition-colors flex items-center justify-center gap-2.5">
                    ...
                    <div className="inline-flex items-center rounded-md border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent relative z-10 whitespace-nowrap text-xs text-black shadow-none bg-gray-300 hover:bg-gray-300">Save 25%</div>
                </button>
            </div>
            ...
            <div className="flex justify-center items-center w-3/5 gap-5 mx-auto">
                <div className="w-64 relative flex flex-col gap-8 overflow-hidden rounded-2xl border p-6 shadow bg-background text-foreground">
                    <h2 className="flex items-center gap-3 text-xl font-medium capitalize">Starter</h2>
                    <div className="relative h-12 flex">
                        <h1 className="text-4xl font-medium">₵0</h1>
                        <small className="align-bottom">.00</small>
                    </div>
                    <div className="flex-1 space-y-2">
                        <h3 className="text-sm font-medium">Perfect for individual practitioners</h3>
                        <ul className="space-y-2">
                            ...
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-badge-check">
                                <path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path>
                                <path d="m9 12 2 2 4-4"></path></svg>PDF report download</li>
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-badge-check">
                                    <path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path>
                                    <path d="m9 12 2 2 4-4"></path>
                ...
                <div className="w-64 relative flex flex-col gap-8 overflow-hidden rounded-2xl border p-6 shadow bg-background text-foreground outline outline-[rgba(120,119,198)]">
                    ...
                    <h2 className="flex items-center gap-3 text-xl font-medium capitalize">Professional
                        <div className="inline-flex items-center rounded-md border text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent shadow mt-1 bg-orange-900 px-1 py-0 text-white hover:bg-orange-900">🔥 Popular</div>
                    </h2>
                    <div className="relative h-12">
                        <span className="text-4xl font-medium">₵150</span>
                        <p className="-mt-2 text-xs font-medium">Per month</p>
                    </div>
                    <div className="flex-1 space-y-2">
                        <h3 className="text-sm font-medium">Ideal for clinics and hospitals</h3>
                        <ul className="space-y-2">
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-badge-check"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="m9 12 2 2 4-4"></path></svg>50 PFT Reports per month
                            </li>
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-badge-check"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="m9 12 2 2 4-4"></path></svg>Advanced AI interpretation
                            </li>
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-badge-check"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="m9 12 2 2 4-4"></path></svg>Interactive chat support
                            </li>
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-badge-check"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="m9 12 2 2 4-4"></path></svg>Priority support
                            </li>
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-badge-check"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path><path d="m9 12 2 2 4-4"></path></svg>Up to 3 users
                            </li>
                        </ul>
                    </div>
                ...
                <div className="w-64 relative flex flex-col gap-8 overflow-hidden rounded-2xl border p-6 shadow bg-background text-foreground">
                    <h2 className="flex items-center gap-3 text-xl font-medium capitalize">Enterprise</h2>
                    <div className="relative h-12">
                        <span className="text-4xl font-medium">₵450</span>
                        <p className="-mt-2 text-xs font-medium">Per month</p>
                    </div>
                    <div className="flex-1 space-y-2">
                        <h3 className="text-sm font-medium">For large healthcare facilities</h3>
                        <ul className="space-y-2">
                            <li className="flex items-center gap-2 text-sm font-medium text-foreground/60">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-badge-check">
                                    <path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z"></path>
